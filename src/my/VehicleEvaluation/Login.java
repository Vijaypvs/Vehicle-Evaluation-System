...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
      ...
      DriverManager.registerDriver (new oracle.jdbc.driver.OracleDriver());
       conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","LOGIN","mohit123");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Vehicle Evaluation System");
...
while(rset.next())
{
    ...
    if(Username.equals(rset.getString("UserID"))&&Pass.equals(rset.getString("Password")))
    {
        
        flag=1;
        VehicleEvaluationUI obj3=new VehicleEvaluationUI();
    ...
    {
        jLabel6.setText("UserId doesn't exist or Password Incorrect");
    }
