...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please enter your details for Sign Up:");
...
while(rset.next())
{
        if(Username.equals(rset.getString("UserID")))
            flag=0;
}      
...
if(flag==1)
    ...
    if(Pass1.equals(Pass2))
    {
        ...
        stmt.executeUpdate("insert into Login values('"+Username+"','"+Pass1+"','"+Name+"','"+Email+"')");
        Login obj5 =new Login();
        obj5.setVisible(true);
        this.setVisible(false);
    }
    else
    {jLabel9.setText("Passwords doesn't Match");}  
    }
else
